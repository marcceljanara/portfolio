...
export const projectsData = [
  ...
  },
  {
    ...
    screenshots: [
      { src: '/screenshots/tenaga-rakyat/landing-page.png', caption: 'Landing Page' },
      { src: '/screenshots/tenaga-rakyat/register.png', caption: 'Register Page' },
      { src: '/screenshots/tenaga-rakyat/login.png', caption: 'Login Page' },
      { src: '/screenshots/tenaga-rakyat/job-search.png', caption: 'Job Listing & Search' },
      { src: '/screenshots/tenaga-rakyat/job-detail.png', caption: 'Job Detail & Application Form' },
      { src: '/screenshots/tenaga-rakyat/employer-dashboard.png', caption: 'Employer Dashboard' },
      { src: '/screenshots/tenaga-rakyat/posting-credit.png', caption: 'Posting Credit Package' },
      { src: '/screenshots/tenaga-rakyat/worker-dashboard.png', caption: 'Worker Dashboard' },
      { src: '/screenshots/tenaga-rakyat/review.png', caption: 'Review System' },
      { src: '/screenshots/tenaga-rakyat/admin-dashboard-2.png', caption: 'Admin Dashboard'},
      { src: '/screenshots/tenaga-rakyat/master-credit-package.png', caption: 'Master Data Credit Package'},
    ],
  },
  {
    id: 'rover-drone-api',
